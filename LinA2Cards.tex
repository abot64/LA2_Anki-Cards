...
\begin{note}
    ...
    \xfield{
        Das \textbf{Tensorprodukt} $V_1\otimes\cdots\otimes V_n$ von $K$-Vektorräumen $V_1,\cdots,V_n$ ist ein $K$-Vektorraum zusammen mit einer (kanonischen) Abbildung\\ $\text{can}\colon V_1\times \cdots \times V_n \longrightarrow V_1\otimes\cdots\otimes V_n$
