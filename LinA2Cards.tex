...
\begin{note}
    ...
    \xfield{
        Die darstellende Matrix \(M(\eta)\) zu einer Sesquilinearform \(\eta\) hat die Form \dots
    }
    \begin{field}
        Die darstellende Matrix \(M(\eta)\) zu einer Sesquilinearform \(\eta\) hat die Form
