...
\begin{note}
    \tags{Satz}
    \xplain{d6bba2ed-dd4d-4fb4-b9fe-ac2d4c343844}

    \xfield{
        Eine lineare Abbildung $f$ ist genau dann \emph{injektiv}, wenn \hint{duale Abbildung}\hide{die duale Abbildung $f^*$ surjektiv ist.}
    }
    \begin{field}
        Eine lineare Abbildung $f$ ist genau dann \emph{injektiv}, wenn die duale Abbildung $f^*$ surjektiv ist.
        \cite{Kor. 16.13}
    \end{field}

    \xfield{
        Eine lineare Abbildung $f$ ist genau dann \emph{surjektiv}, wenn \hint{duale Abbildung}\hide{die duale Abbildung $f^*$ injektiv ist.}
    }
    \begin{field}
        Eine lineare Abbildung $f$ ist genau dann \emph{surjektiv}, wenn die duale Abbildung $f^*$ injektiv ist.
        \cite{Kor. 16.13}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{2948efa5-9029-4284-a634-ee09edfad4b2}

    \xfield{
        Sei $V$ ein endlich-dimensionaler Vektorraum, dann gilt für jeden Untervektorraum $U\subseteq V$:
        \[\dim(U^0) = \]
    }
    \begin{field}
        Sei $V$ ein endlich-dimensionaler Vektorraum, dann gilt für jeden Untervektorraum $U\subseteq V$:
...
\begin{note}
    \tags{Def}
    \xplain{ae8e8491-fda3-474b-87b0-beaf8e05f0e3}

    \xfield{
        Der \textbf{Bidualraum} eines $K$-Vektorraums $V$ ist \dots
    }
    \begin{field}
        Der \textbf{Bidualraum} eines $K$-Vektorraums $V$ ist
        \[V^{**}:= (V^*)^*\]
        \cite{Def. 16.15}
    \end{field}

    \xfield{
        Der \textbf{Bidualraumhomomorphismus} ist die Abbildung
        \[\omega_V\colon\]
    }
    \begin{field}
        Der \textbf{Bidualraumhomomorphismus} ist die Abbildung
        \begin{align*}
            \omega_V\colon V &\longrightarrow V^{**}\\
            \vec{v} &\mapsto \begin{pmatrix}
                V^* & \longrightarrow &K\\
                \phi & \mapsto &\phi(\vec{v})
        \end{pmatrix}
        \end{align*}
        \cite{Def. 16.15}
    \end{field}
...
\begin{note}
    \tags{Satz}
    \xplain{730505c9-1d7c-4524-8246-22a4cbbab07a}

    \xfield{
        Der Bidualraumhomomorphismus $\omega_V$ ist \hint{Linearität} \hide{$K$-linear}.
    }
    \begin{field}
        Der Bidualraumhomomorphismus $\omega_V$ ist $K$-linear.
        \cite{Notiz 16.16}
    \end{field}

    \xfield{
        Sei $f\colon V  \longrightarrow W$ eine Abbildung und $\omega_W$ der Bidualraumhomomorphismus von $W$. Dann gilt
        \[\omega_W \circ f = \]
    }
    \begin{field}
        Sei $f\colon V  \longrightarrow W$ eine Abbildung und $\omega_W$ der Bidualraumhomomorphismus von $W$. Dann gilt
        \[\omega_W \circ f = f^{**} \circ \omega_V\]
        mit $f^{**} \colon V^{**} \longrightarrow W^{**}$ und $\omega_V$ der Bidualraumhomomorphismus zu $V$.
        \cite{Notiz 16.17}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{26f469cc-ef15-4f31-83a9-89e412e0edf2}

    \xfield{
        Der Bidualraumhomomorphismus ist \hint{injektiv? surjektiv?}\hide{injektiv}.
    }
    \begin{field}
        Der Bidualraumhomomorphismus ist injektiv.
        \cite{Satz 16.18}
    \end{field}

    \xfield{
        Der Bidualraumhomomorphismus ist genau dann \hide{ein Isomorphismus}, wenn $V$ endlich-dimensional ist.
    }
    \begin{field}
        Der Bidualraumhomomorphismus ist genau dann ein Isomorphismus, wenn $V$ endlich-dimensional ist.
        \cite{Satz 16.18}
    \end{field}


    \xfield{
        Der Bidualraumhomomorphismus ist genau dann ein Isomorphismus, wenn \hide{$V$ endlich-dimensional ist}.
    }
    \begin{field}
        Der Bidualraumhomomorphismus ist genau dann ein Isomorphismus, wenn $V$ endlich-dimensional ist.
        \cite{Satz 16.18}
...
\begin{note}
    \tags{Satz}
    \xplain{b36837bf-1b54-4cdf-9bfd-241a2bd3ba01}

    \xfield{
        Sei $(V, \scprod{\cdot}{\cdot})$ ein endlich-dimensionaler euklidischer Vektorraum.\\
        Dann ist die Abbildung
        \begin{align*}
            \psi\colon V &\longrightarrow V^{*}\\
            \vec{v} &\mapsto \scprod{\vec{v}}{\cdot}
        \end{align*}
        \dots
    }
    \begin{field}
        ...
        \begin{align*}
            ...
            \vec{v} &\mapsto \scprod{\vec{v}}{\cdot}
        \end{align*}
        ein \emph{kanonischer Isomorphismus} zu $V \cong V^*$.
        \cite{Satz 16.19}
    \end{field}
    ...
    \xfield{
        ...
        \begin{align*}
            \psi\colon V &\longrightarrow V^{*}\\
            \vec{v} &\mapsto \phantom{\scprod{\vec{v}}{\cdot}}
        \end{align*}
        ein \emph{kanonischer Isomorphismus} zu $V \cong V^*$.
    }
    \begin{field}
...
\tags{LinA-II-17-Multilineare-Algebren}

%%%%%%%%% Vorlesung 20 %%%%%%%%%%%%

\begin{note}
    \tags{Def}
    \xplain{4bfc9556-8182-4a6d-ba13-e65645147b5c}

    \xfield{
        Seien $V_1,\dots,V_n,W$ $K$-Vektorräume. Eine Abbildung
        \[f\colon V_1\times\cdots\times V_n \longrightarrow W\]
        ist \textbf{$K$-multilinear}, falls \dots
    }
    \begin{field}

            Seien $V_1,\dots,V_n,W$ $K$-Vektorräume. Eine Abbildung
            \[f\colon V_1\times\cdots\times V_n \longrightarrow W\]
            ist \textbf{$K$-multilinear}, falls für jedes $i\in\{1,\dots,n\}$ und beliebige Vektoren $\vec{v}_1,\dots,\vec{v}_{i-1},\vec{v}_{i+1},\dots,\vec{v}_n$ die Abbildung
            \begin{align*}
                V_i &\longrightarrow W\\
                \vec{v} &\mapsto f(\vec{v}_1,\dots,\vec{v}_{i-1}, \vec{v}, \vec{v}_{i+1},\dots,\vec{v}_n)
            \end{align*}
            $K$-linear ist.
            \cite{Def. 17.5}
    \end{field}
...
\begin{note}
    \tags{Def Satz}
    \xplain{78d71d52-c77f-4bf8-8312-ce13d136f6f1}

    \xfield{
        Das \textbf{Tensorprodukt} $V_1\otimes\cdots\otimes V_n$ von $K$-Vektorräumen $V_1,\cdots,V_n$ ist ein $K$-Vektorraum, der definiert wird durch eine kanonische Abbildung\\ $\text{can}\colon V_1\times \cdots \times V_n \longrightarrow V_1\otimes\cdots\otimes V_n$
        mit folgender universellen Eigenschaft:\\
        $\text{can}$ ist \hide{multilinear} und\\
         für jeden $K$-Vektorraum $T$ und jede multilineare Abbildung $t\colon V_1\times\cdots\times V_n \longrightarrow T$
        existiert genau eine $K$-lineare Abbildung
        $t'\colon V_1\times\cdots\times V_n \longrightarrow T$\\
        mit $t'\circ \text{can} = t$.
    }
    \begin{field}
        Das \textbf{Tensorprodukt} $V_1\otimes\cdots\otimes V_n$ von $K$-Vektorräumen $V_1,\cdots,V_n$ ist ein $K$-Vektorraum, der definiert wird durch eine kanonische Abbildung\\ $\text{can}\colon V_1\times \cdots \times V_n \longrightarrow V_1\otimes\cdots\otimes V_n$
        mit folgender universellen Eigenschaft:\\
        $\text{can}$ ist multilinear und\\
         für jeden $K$-Vektorraum $T$ und jede multilineare Abbildung $t\colon V_1\times\cdots\times V_n \longrightarrow T$
        existiert genau eine $K$-lineare Abbildung
        $t'\colon V_1\times\cdots\times V_n \longrightarrow T$\\
        mit $t'\circ \text{can} = t$.
        \cite{Satz 17.6 / Def. 17.7}
    \end{field}
    ...
    \xfield{
        ...
        $\text{can}$ ist multilinear und\\
         für jeden $K$-Vektorraum $T$ und jede multilineare Abbildung $t\colon V_1\times\cdots\times V_n \longrightarrow T$
        existiert \hide{genau eine $K$-lineare Abbildung
        $t'\colon V_1\times\cdots\times V_n \longrightarrow T$\\
        mit $t'\circ \text{can} = t$}.
    }
    \begin{field}
...
\begin{note}
    \tags{Def}
    \xplain{aecec954-a8b3-4cf0-9088-efac1f16f0cf}

    \xfield{
        Die \textbf{reinen Tensoren} sind \dots
    }
    \begin{field}
        Die \textbf{reinen Tensoren} sind die Vektoren im Bild von \emph{can}:
        \[\vec{v}_1\otimes\dots\otimes\vec{v}_n := \text{can}(\vec{v}_1,\dots,\vec{v}_n)\]
        \cite{Def. 17.8}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{da356929-7f8c-491d-b199-e2c65bfc393d}

    \xfield{
        Seien $B = (\vec{b}_i)_{i\in I}$ Basis von $V$, $C = (\vec{c}_j)_{j\in J}$ Basis von $W$. Dann ist eine Basis von $V\otimes W$:
        \hide{\[(\vec{b}_i\otimes \vec{c}_j)_{i\in I, j\in J}\]}
    }
    \begin{field}
        Seien $B = (\vec{b}_i)_{i\in I}$ Basis von $V$, $C = (\vec{c}_j)_{j\in J}$ Basis von $W$. Dann ist eine Basis von $V\otimes W$:
        \[(\vec{b}_i\otimes \vec{c}_j)_{i\in I, j\in J}\]
        \cite{Kor. 17.13}
    \end{field}

    \xfield{
        Für endlich-dimensionale Vektorräume $V, W$ gilt
        \[\dim V\otimes W = \phantom{\dim V \cdot \dim W}\]
    }
    \begin{field}
        Für endlich-dimensionale Vektorräume $V, W$ gilt
...
\begin{note}
    \tags{Satz Def}
    \xplain{a360a5b0-ab37-4113-94f4-c118a467429f}

    \xfield{
        Sind $f_i\colon V_i \longrightarrow W_i$ für $i \in \{1,\dots,n\}$ $K$-lineare Abbildungen, so existiert \hint{Tensor}\dots
    }
    \begin{field}
        Sind $f_i\colon V_i \longrightarrow W_i$ für $i \in \{1,\dots,n\}$ $K$-lineare Abbildungen, so existiert genau eine $K$-lineare Abbildung
        \[f_1\otimes\dots\otimes f_n \colon V_1\otimes\dots\otimes V_n \longrightarrow W_1\otimes \dots W_n\]
        mit
        \[\vec{v}_1\otimes\dots\vec{v}_n \mapsto f_1(\vec{v}_1)\otimes\dots\otimes f_n(\vec{v}_n)\]
        \cite{Satz/Def. 17.17}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Def}
    \xplain{7c994a34-00c4-44b1-ba2d-d4c8e975c360}

    \xfield{
        \textbf{Tensorprodukt von Matrizen}\\
        Seien $A = (a_{ij})_{ij}\in \Mat(m\times n), B\in\Mat_K(p\times q)$. Dann ist
        \[A\otimes B := \phantom{\begin{pmatrix}
            a_{11}B &\cdots& a_{1n}B\\
            a_{21}B &\cdots& a_{2n}B\\
            \vdots && \vdots\\
            a_{m1}B &\cdots &a_{mn}B
        \end{pmatrix}\in\Mat(mp \times nq)}\]
    }
    \begin{field}
        \textbf{Tensorprodukt von Matrizen}\\
        Seien $A = (a_{ij})_{ij}\in \Mat(m\times n), B\in\Mat_K(p\times q)$. Dann ist
...
\begin{note}
    \tags{Satz}
    \xplain{838e5316-141f-4294-bf5d-64da0883b96b}

    \xfield{
        Seien $f_1\colon V_1\longrightarrow W_1$, $f_2\colon V_2\longrightarrow W_2$ linear und seien die Basen der Vektorräume wie folgt:\\
        \begin{tabular}{rl}
            $V_1$: & $B_1 = (\vec{b}_1^{(1)},\dots,\vec{b}_n^{(1)})$\\
            $V_2$: & $B_2 = (\vec{b}_1^{(2)},\dots,\vec{b}_q^{(2)})$\\
            $W_1$: & $C_1 = (\vec{c}_1^{(1)},\dots,\vec{c}_m^{(1)})$\\
            $W_2$: &  $C_2 = (\vec{c}_1^{(2)},\dots,\vec{c}_p^{(2)})$\\ \hline
            $V_1\otimes V_2$: & "$B_1\otimes B_2 := (\vec{b}_1^{(1)}\otimes B_2, \dots, \vec{b}_n^{(1)}\otimes B_2)$"\\
            $W_1\otimes W_2$: & "$C_1\otimes C_2 := (\vec{c}_1^{(1)}\otimes C_2, \dots, \vec{c}_m^{(1)}\otimes C_2)$"
        \end{tabular}\\
        Dann gilt:
        \[_{C_1\otimes C_2}M_{B_1\otimes B_2}(f_1\otimes f_2) =\phantom{ _{C_1}M_{B_1}(f_1)\otimes _{C_2}M_{B_2}(f_2)}\]
    }
    \begin{field}
        Seien $f_1\colon V_1\longrightarrow W_1$, $f_2\colon V_2\longrightarrow W_2$ linear und seien die Basen der Vektorräume wie folgt:\\
        \begin{tabular}{rl}
        ...
        \end{tabular}\\
        Dann gilt:
        \[_{C_1\otimes C_2}M_{B_1\otimes B_2}(f_1\otimes f_2) = _{C_1}M_{B_1}(f_1)\otimes _{C_2}M_{B_2}(f_2)\]
        \cite{Satz 17.21}
    \end{field}
    ...
    \xfield{
        ...
        \begin{tabular}{rl}
            ...
            $W_1$: & $C_1 = (\vec{c}_1^{(1)},\dots,\vec{c}_m^{(1)})$\\
            $W_2$: &  $C_2 = (\vec{c}_1^{(2)},\dots,\vec{c}_p^{(2)})$\\ \hline
            $V_1\otimes V_2$: & \hide{"$B_1\otimes B_2 := (\vec{b}_1^{(1)}\otimes B_2, \dots, \vec{b}_n^{(1)}\otimes B_2)$"}\\
            $W_1\otimes W_2$: & \hide{"$C_1\otimes C_2 := (\vec{c}_1^{(1)}\otimes C_2, \dots, \vec{c}_m^{(1)}\otimes C_2)$"}
        \end{tabular}\\
        Dann gilt:
        \[_{\phantom{C_1\otimes C_2}\dots}M_{\dots\phantom{B_1\otimes B_2}}(f_1\otimes f_2) = _{C_1}M_{B_1}(f_1)\otimes _{C_2}M_{B_2}(f_2)\]
    }
    \begin{field}
        Seien $f_1\colon V_1\longrightarrow W_1$, $f_2\colon V_2\longrightarrow W_2$ linear und seien die Basen der Vektorräume wie folgt:\\
        \begin{tabular}{rl}
...
%%%%%%%%%
% Vorlesung 23 bis 25 fielen krankheitsbedingt aus
%%%%%%%%%

%%%%%%%%% Vorlesung 26 (letzte Vorlesung) %%%%%%%%%%%%
\begin{note}
    \tags{Satz}
    \xplain{1e63fc67-47a6-4f83-92bf-43e5f588d27e}

    \xfield{
        Für multiplizierbare Matrizen $A_1$ und $A_2$, und für multiplizierbare Matrizen $B_1$ und $B_2$ gilt:
        \[(A_1\otimes A_2)\cdot(B_1\otimes B_2) = \phantom{(A_1\cdot A_2)\otimes (B_1\cdot B_2)}\]
    }
    \begin{field}
        Für multiplizierbare Matrizen $A_1$ und $A_2$, und für multiplizierbare Matrizen $B_1$ und $B_2$ gilt:
...
\begin{note}
    \tags{Satz}
    \xplain{2c6f1b14-47cb-42fa-81ad-0f81fdada19a}

    \xfield{
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Falls $f$ ein Isomorphismus ist, so ist
        \[f \otimes \id_U\colon V\otimes U\longrightarrow W\otimes U\]
        \dots
    }
    \begin{field}
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Falls $f$ ein Isomorphismus ist, so ist
    ...
    \xfield{
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Für $f \otimes \id_U\colon V\otimes U\longrightarrow W\otimes U$ gilt:
        \[\ker(f\otimes \id_U) \cong \phantom{\ker f \otimes U}\]
    }
    \begin{field}
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Für $f \otimes \id_U\colon V\otimes U\longrightarrow W\otimes U$ gilt:
        \[\ker(f\otimes \id_U) \cong \ker f \otimes U\]
        \cite{Satz 17.23}
    \end{field}

    \xfield{
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Für $f \otimes \id_U\colon V\otimes U\longrightarrow W\otimes U$ gilt:
        \[\im(f\otimes \id_U) \cong \phantom{\im f \otimes U}\]
    }
    \begin{field}
        Sei $f\colon V\longrightarrow W$ linear und $U$ ein weiterer Vektorraum. Für $f \otimes \id_U\colon V\otimes U\longrightarrow W\otimes U$ gilt:
        \[\im(f\otimes \id_U) \cong \im f \otimes U\]
        \cite{Satz 17.23}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Def}
    \xplain{8da91ed4-2c6a-4b0a-851c-b01758850356}

    \xfield{
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{symmetrisch}, wenn \dots
    }
    \begin{field}
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{symmetrisch}, wenn für beliebige $\vec{v}_1,\dots,\vec{v}_n\in V$ und $\sigma\in S_n$ gilt:
        \[f(\vec{v}_1,\dots,\vec{v}_n) = f(\vec{v}_{\sigma(1)},\dots,\vec{v}_{\sigma(n)})\]
        \cite{Def 17.24}
    \end{field}
    ...
    \xfield{
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{schiefsymmetrisch}, wenn \dots
    }
    \begin{field}
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{schiefsymmetrisch}, wenn für beliebige $\vec{v}_1,\dots,\vec{v}_n\in V$ und $\sigma\in S_n$ gilt:
        \[f(\vec{v}_1,\dots,\vec{v}_n) = \text{sgn}(\sigma)\cdot f(\vec{v}_{\sigma(1)},\dots,\vec{v}_{\sigma(n)})\]
        \cite{Def 17.24}
    \end{field}
    ...
    \xfield{
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{alternierend}, wenn \dots
    }
    \begin{field}
        Eine multilineare Abbildung
        \[f\colon V\times V\times\dots\times V \longrightarrow W\]
        ist \textbf{alternierend}, wenn gilt:
        \[f(\vec{v}_1,\dots,\vec{v}_n) = 0\]
        sobald $\vec{v}_i = \vec{v}_j$ für ein Paar $(i,j)$ mit $i\neq j$.
        \cite{Def 17.24}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{2c117169-6d33-48f3-acd7-ef2d240f4eb8}

    \xfield{
        Zu einem $K$-Vektorraum $V$ und einer Zahl $k\in\NN_0$ existiert ein $K$-Vektorraum $S^k V$ zusammen mit einer Abbildung
        \[\text{can}_S\colon V\times\dots\times V \longrightarrow S^k V\]
    ...
    \begin{field}
        ...
        \[\text{can}_S\colon V\times\dots\times V \longrightarrow S^k V\]
        die folgende universelle Eigenschaft erfüllt:\\
        can$_S$ ist $K$-multilinear und symmetrisch, und für jeden $K$-Vektorraum $T$ und jede $K$-multilineare symmetrische Abbildung
        $t\colon V\times\dots\times V\longrightarrow T$      existiert genau eine lineare Abbildung $t_S$ mit $t = t_S\circ \text{can}_S$.
        \cite{satz 17.28}
    \end{field}

    \xfield{
    Zu einem $K$-Vektorraum $V$ und einer Zahl $k\in\NN_0$ existiert ein $K$-Vektorraum $\Lambda^k V$ zusammen mit einer Abbildung
    \[\text{can}_{\Lambda}\colon V\times\dots\times V \longrightarrow \Lambda^k V\]
    die folgende universelle Eigenschaft erfüllt:\\
    \dots
    }
    \begin{field}
        ...
        \[\text{can}_{\Lambda}\colon V\times\dots\times V \longrightarrow \Lambda^k V\]
        die folgende universelle Eigenschaft erfüllt:\\
        can$_{\Lambda}$ ist $K$-multilinear und alternierend, und für jeden $K$-Vektorraum $T$ und jede $K$-multilineare alternierende Abbildung
        $t\colon V\times\dots\times V\longrightarrow T$      existiert genau eine lineare Abbildung $t_{\Lambda}$ mit $t = t_{\Lambda}\circ \text{can}_{\Lambda}$.
        \cite{Satz 17.28}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Def}
    \xplain{dde4d0f7-4594-4869-9657-2e02cc677f69}

    \xfield{
        \[V^{\otimes k} := \phantom{V\otimes \dots \otimes V}\] ist die \textbf{$k$-te \hide{Tensorpotenz} von $V$}.
    }
    \begin{field}
        \[V^{\otimes k} := V\otimes \dots \otimes V\] ist die \textbf{$k$-te Tensorpotenz von $V$}.
        \cite{Def. 17.29}
    \end{field}

    \xfield{
        $S^k V$ ist die \textbf{$k$-te \hide{symmetrische Potenz} von V}.
    }
    \begin{field}
        $S^k V$ ist die \textbf{$k$-te symmetrische Potenz von V}.
        \cite{Def. 17.29}
    \end{field}

    \xfield{
        $\Lambda^k V$ ist die \textbf{$k$-te \hide{äußere Potenz} von V}.
    }
    \begin{field}
        $\Lambda^k V$ ist die \textbf{$k$-te äußere Potenz von V}.
        \cite{Def. 17.29}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{bb2eb259-bf62-4b35-a333-e61752f6bfa8}

    \xfield{
        Für beliebige $K$-Vektorräume $V$ und $W$ existiert ein kanonischer Isomorphismus
        \[S^k(V\oplus W) \overset{\cong}{\longleftarrow} \phantom{\oplus_{j=0}^k S^j(V)\otimes S^{k-j}(W)}\]
        mit \dots
    }
    \begin{field}
        Für beliebige $K$-Vektorräume $V$ und $W$ existiert ein kanonischer Isomorphismus
        \[S^k(V\oplus W) \overset{\cong}{\longleftarrow} \oplus_{j=0}^k S^j(V)\otimes S^{k-j}(W)\]
        mit
        \[\vec{v}_1\cdot\dots\cdot\vec{v}_j\cdot\vec{w}_{j+1}\cdot\dots\cdot\vec{w}_k \mapsfrom (\vec{v}_1\cdot\dots\cdot\vec{v}_j)\otimes(\vec{w}_{j+1}\cdot\dots\cdot\vec{w}_k)\]
        \cite{Satz 17.33}
    \end{field}

    \xfield{
        Für beliebige $K$-Vektorräume $V$ und $W$ existiert ein kanonischer Isomorphismus
        \[\Lambda^k(V\oplus W) \overset{\cong}{\longleftarrow} \phantom{\oplus_{j=0}^k \Lambda^j(V)\otimes \Lambda^{k-j}(W)}\]
        mit \dots
    }
    \begin{field}
        Für beliebige $K$-Vektorräume $V$ und $W$ existiert ein kanonischer Isomorphismus
        \[\Lambda^k(V\oplus W) \overset{\cong}{\longleftarrow} \oplus_{j=0}^k \Lambda^j(V)\otimes \Lambda^{k-j}(W)\]
        mit
        \begin{align*}
            \vec{v}_1\land\dots\land\vec{v}_j\land\vec{w}_{j+1}\land\dots\land\vec{w}_k \mapsfrom & (\vec{v}_1\land\dots\land\vec{v}_j)\otimes\\
            &(\vec{w}_{j+1}\land\dots\land\vec{w}_k)
        \end{align*}
        \cite{Satz 17.33}
    \end{field}
\end{note}
...
\begin{note}
    \tags{Satz}
    \xplain{a32f90b0-d353-43fd-84c6-7f61075e40bb}

    \xfield{
        Ist $B=(\vec{b}_1,\dots,\vec{b}_n)$ Basis von $V$, so gilt für alle $k\geq 1$:
        \[B_S := \phantom{(\vec{b}_{i_1}\cdot\vec{b}_{i_k})_{1\leq i_1 \leq\dots\leq i_k\leq n}}\]
        ist eine Basis von $S^k V$.
    }
    \begin{field}
        Ist $B=(\vec{b}_1,\dots,\vec{b}_n)$ Basis von $V$, so gilt für alle $k\geq 1$:
        \[B_S := (\vec{b}_{i_1}\cdot\vec{b}_{i_k})_{1\leq i_1 \leq\dots\leq i_k\leq n}\]
        ist eine Basis von $S^k V$.
        \cite{Kor. 17.34}
    \end{field}
    ...
    \xfield{
        Ist $B=(\vec{b}_1,\dots,\vec{b}_n)$ Basis von $V$, so gilt für alle $k\geq 1$:
        \[B_\Lambda := \phantom{(\vec{b}_{i_1}\cdot\vec{b}_{i_k})_{1\leq i_1 <\dots< i_k\leq n}}\]
        ist eine Basis von $\Lambda^k V$.
    }
    \begin{field}
        Ist $B=(\vec{b}_1,\dots,\vec{b}_n)$ Basis von $V$, so gilt für alle $k\geq 1$:
        \[B_S := (\vec{b}_{i_1}\cdot\vec{b}_{i_k})_{1\leq i_1 <\dots< i_k\leq n}\]
        ist eine Basis von $S^k V$.
        \cite{Kor. 17.34}
    \end{field}

    \xfield{
    Sei $V$ ein Vektorraum mit $\dim V = n$. Dann gilt für alle $k\geq 0$:
    \[\dim S^k V = \phantom{\binom{n+k-1}{k}}\]
    }
    \begin{field}
        Sei $V$ ein Vektorraum mit $\dim V = n$. Dann gilt für alle $k\geq 0$:
    ...
    \xfield{
    Sei $V$ ein Vektorraum mit $\dim V = n$. Dann gilt für alle $k\geq 0$:
    \[\dim \Lambda^k V = \phantom{\binom{n}{k}}\]
    }
    \begin{field}
        Sei $V$ ein Vektorraum mit $\dim V = n$. Dann gilt für alle $k\geq 0$:
...
\begin{note}
    \tags{Satz Def}
    \xplain{48a522dd-cb93-4cc3-ab8b-8a0893c0a4da}

    \xfield{
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te Tensorpotenz von $f$}
        \[f^{\otimes k}\colon \phantom{V^{\otimes k} \longrightarrow W^{\otimes k}}\]
    }
    \begin{field}
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te Tensorpotenz von $f$}
        \[f^{\otimes k}\colon V^{\otimes k} \longrightarrow W^{\otimes k}\]
        mit
        \[\vec{v}_1\otimes\dots\otimes\vec{v}_k\mapsto f(\vec{v}_1)\otimes\dots\otimes f(\vec{v}_k)\]
        \cite{Satz/Def. 17.35}
    \end{field}

    \xfield{
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te symmetrische Potenz von $f$}
        \[S^k f\colon \phantom{S^kV \longrightarrow S^kW}\]
    }
    \begin{field}
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te symmetrische Potenz von $f$}
        \[S^kf\colon S^kV \longrightarrow S^kW\]
        mit
        \[\vec{v}_1\cdot\dots\cdot\vec{v}_k\mapsto f(\vec{v}_1)\cdot\dots\cdot f(\vec{v}_k)\]
        \cite{Satz/Def. 17.35}
    \end{field}

    \xfield{
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te äußere Potenz von $f$}
        \[\Lambda^k f\colon \phantom{\Lambda^kV \longrightarrow \Lambda^kW}\]
    }
    \begin{field}
        Zu jeder $K$-linearen Abbildung $f\colon V\longrightarrow W$ existiert für jedes $k\in \NN$ die \textbf{$k$-te äußere Potenz von $f$}
        \[\Lambda^kf\colon \Lambda^kV \longrightarrow \Lambda^kW\]
        mit
        \[\vec{v}_1\land\dots\land\vec{v}_k\mapsto f(\vec{v}_1)\land\dots\land f(\vec{v}_k)\]
        \cite{Satz/Def. 17.35}
    \end{field}
\end{note}
